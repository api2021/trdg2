...
def chck_font_support(font_path, text_to_check):
    try:
...
def _generate_horizontal_text(
    ...
    word_split: bool,
    stroke_width: int = 0,
    stroke_fill: str = "#282828",transparent=0.5
) -> Tuple:
    ...
    fill = (
        ...
        rnd.randint(int(255*transparent), 255),
    )
