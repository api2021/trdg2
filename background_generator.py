...
def random_color_background(height, width):
...
def random_pixel_background(height, width):
    img = Image.new("RGBA", (width, height), rnd.choice(['white','black']))
    for y in range(height):
        for x in range(width):
            img.putpixel((x, y), (rnd.randint(10, 180), rnd.randint(10, 180), rnd.randint(10, 180), rnd.randint(50, 200)))
    return img
